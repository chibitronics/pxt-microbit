namespace pxsim {
  ...
  export class Pin {
    ...
    isChibitronicsSwitchConnected = false; // Added for chibi-clip visualizer
    pitch = false;
    pull = 0; // PullDown
    ...
    connectChibitronicsSwitch() {
      this.isChibitronicsSwitchConnected = true;
      this.digitalWritePin(0);
      runtime.queueDisplayUpdate();
    }

    disconnectChibitronicsSwitch() {
      this.isChibitronicsSwitchConnected = false;
      this.digitalWritePin(1);
      runtime.queueDisplayUpdate();
    }
    ...
    setPull(pull: number) {
      ...
      switch (pull) {
        ...
        case PinPullMode.PullUp:
          this.value = PIN_MAX_VALUE;
          break;
        default:
          this.value = Math_.randomRange(0, PIN_MAX_VALUE);
          break;
      }
    }
